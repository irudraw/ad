...
$query[] = "CREATE TABLE IF NOT EXISTS `".trim($_POST["prefix"])."user` (
  ...
  `overlay` text NULL,
  `fbpixel` varchar(255) NULL,
  `linkedinpixel` varchar(255) NULL,
  `adwordspixel` varchar(255) NULL,
